...
import $css_2 from 'Frontend/styles/menu-buttons.css';
addCssBlock(`<custom-style><style>${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles/menu-links.css';
addCssBlock(`<custom-style><style>${$css_3}</style></custom-style>`);
import $css_4 from 'Frontend/styles/report-view.css';
addCssBlock(`<custom-style><style>${$css_4}</style></custom-style>`);
import $css_5 from 'Frontend/styles/scan-input.css';
addCssBlock(`<dom-module id="flow_css_mod_5" theme-for="vaadin-text-field"><template><style>${$css_5}</style></template></dom-module>`);
import $css_6 from 'Frontend/styles/login-form-style.css';
